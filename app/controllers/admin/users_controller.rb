class Admin::UsersController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to admin_user_path(@user), notice: 'Gg was successfully created.' }
  ...
  def user_params
    params.require(:user).permit(:name, :phone, :birthday, :enable).merge(branch_id: session[:branch_id])
  end
end
